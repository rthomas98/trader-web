<?php
// Simple test script for deposits without wallet_id
...
try {
    ...
    try {
        ...
        $columns = DB::getSchemaBuilder()->getColumnListing('funding_transactions');
        logOutput("Available columns in funding_transactions: " . implode(', ', $columns));
        ...
        // Don't set wallet_id if it doesn't exist in the table
